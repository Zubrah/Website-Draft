		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">ZENJI <span>HOTEL</span><p class="logo_w3l_agile_caption">Your Dream Resort</p></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1"<div class="social-bnr-agileits">
	...
	<div id="home" class="w3ls-banner">
		...
		<div class="slider">
			<div class="callbacks_container">
				...
				<a href="#" class="menu__link" data-toggle="modal" data-target="#Gallery">Learn More</a>
			</div>
								</div>	
							</div>
						</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Zenji Hotels</h3> 
						   ...
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>A an experience that lets you live your dream </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+255 -716-73-53-15</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@ZENJIHOTELS.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> KIMIHIRURA Road, KH, KIGALI, RWANDA</p>
			...
			<iframe src="https://www.google.com/maps/place/Kigali+Heights/@-1.9530718,30.0909422,17z/data=!3m1!4b1!4m5!3m4!1s0x19dca6f3a6d7d373:0xda6c2b3cabfec246!8m2!3d-1.9530718!4d30.0931309" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
